...
{
    public class RequestAccessTokenUsingRefreshTokenTokenProvider : BaseAuthAzureTokenProvider, IAuthAzureTokenProvider
    {
        public RequestAccessTokenUsingRefreshTokenTokenProvider(HttpClient httpClient) : base(httpClient)
        {
        }
